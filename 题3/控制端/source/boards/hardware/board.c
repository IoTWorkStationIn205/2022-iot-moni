...
void BoardInitPeriph( void )
{
	...
	GpioInit( &Re, PB_2, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
	
    GpioInit( &Key2, KEY_2, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0 );
	GpioInit( &Key3, PB_1, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0 );
	GpioInit( &Key4, PB_5, PIN_INPUT, PIN_PUSH_PULL, PIN_PULL_UP, 0 );
	
	GpioSetInterrupt(&Key2,IRQ_FALLING_EDGE,IRQ_VERY_LOW_PRIORITY,&Key2Call);
	GpioSetInterrupt(&Key3,IRQ_FALLING_EDGE,IRQ_VERY_LOW_PRIORITY,&Key3Call);
	GpioSetInterrupt(&Key4,IRQ_FALLING_EDGE,IRQ_VERY_LOW_PRIORITY,&Key4Call);
